                                    ...
                                    <div class="flipper">
                                        <div class="front">
                                            <a href="<?php echo base_url('saree/detail')?>">
                                                <img src="<?php echo base_url();?>assets/home-css/img/festive1.jpg" alt="" class="img-responsive">
                                            </a>
                                        </div>
                                        <div class="back">
                                            <a href="<?php echo base_url('saree/detail')?>">
                            ...
                            <div class="product">
                                <div class="flip-container">
                                    <div class="flipper">
                                        <div class="front">
                                            <a href="<?php echo base_url('saree/detail')?>">
                                                <img src="<?php echo base_url();?>assets/home-css/img/festive2.jpg" alt="" class="img-responsive">
                                            </a>
                                        </div>
                                        <div class="back">
                                            <a href="<?php echo base_url('saree/detail')?>">
                            ...
                            <div class="product">
                                <div class="flip-container">
                                    <div class="flipper">
                                        <div class="front">
                                            <a href="<?php echo base_url('saree/detail')?>">
                                                <img src="<?php echo base_url();?>assets/home-css/img/festive3.jpg" alt="" class="img-responsive">
                                            </a>
                                        </div>
                                        <div class="back">
                                            <a href="<?php echo base_url('saree/detail')?>">
                            ...
                            <div class="product">
                                <div class="flip-container">
                                    <div class="flipper">
                                        <div class="front">
                                            <a href="<?php echo base_url('saree/detail')?>">
                                                <img src="<?php echo base_url();?>assets/home-css/img/festive4.jpg" alt="" class="img-responsive">
                                            </a>
                                        </div>
                                        <div class="back">
                                            <a href="<?php echo base_url('saree/detail')?>">
                            ...
                            <div class="product">
                                <div class="flip-container">
                                    <div class="flipper">
                                        <div class="front">
                                            <a href="<?php echo base_url('saree/detail')?>">
                                                <img src="<?php echo base_url();?>assets/home-css/img/festive5.jpg" alt="" class="img-responsive">
                                            </a>
                                        </div>
                                        <div class="back">
                                            <a href="<?php echo base_url('saree/detail')?>">
                            ...
                            <div class="product">
                                <div class="flip-container">
                                    <div class="flipper">
                                        <div class="front">
                                            <a href="<?php echo base_url('saree/detail')?>">
                                                <img src="<?php echo base_url();?>assets/home-css/img/festive6.jpg" alt="" class="img-responsive">
                                            </a>
                                        </div>
                                        <div class="back">
                                            <a href="<?php echo base_url('saree/detail')?>">
